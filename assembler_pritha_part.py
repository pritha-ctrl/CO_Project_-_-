...
def check_error_type_C(instruction):
    if len(instruction)!=3:
        ...
        return 0
    elif instruction[1] not in register or instruction[2] not in register:
...
def check_error_type_D(instruction):
    if len(instruction)!=3:
        ...
        print("Typos in instruction name or register name",end="")
        return 0
    elif instruction[2] not in variable_values:
        print("Use of undefined variables",end="")
        return 0
    elif instruction[2] in labels:
        print("Misuse of labels as variables or vice-versa",end="")
        return 0
    elif instruction[1] == "FLAGS" or instruction[2] == "FLAGS":
        print("Illegal use of FLAGS register",end="")
        return 0
